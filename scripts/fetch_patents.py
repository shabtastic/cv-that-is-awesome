...
# reliably populate patentNumber in applicationMetaData, including for cases that
# have already reached "Patented Case". Keying grant detection on patentNumber
# alone (as this script originally did) therefore never fires: check-status
# reported "No status changes found" whether or not anything had issued.
