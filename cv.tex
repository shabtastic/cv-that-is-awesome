...
\DeclareNameAlias{sortname}{boldifown}% numeric style routes through sortname
\DeclareNameAlias{editor}{boldifown}
\DeclareNameAlias{inventor}{boldifown}% @patent entries use inventor list
\AtBeginDocument{%
  \DeclareNameAlias{author}{boldifown}%
  \DeclareNameAlias{sortname}{boldifown}%
  \DeclareNameAlias{editor}{boldifown}%
...
% Redefine here to use \vspace{-2.0mm} to fully cancel the 1mm trailing + partial
% compensation, making all inter-entry gaps uniform.
\renewenvironment{cvitems}{%
  ...
  \end{itemize}%
  \end{justify}%
  \vspace{-2.0mm}% was 1.0mm in cls; increased negation for uniform inter-entry gaps
}
