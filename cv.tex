...
\AtBeginDocument{%
  ...
  \DeclareNameAlias{inventor}{boldifown}%  % @patent uses inventor list
}
...
% Increase inter-section breathing room
\renewcommand{\acvSectionTopSkip}{7mm}

% Fix inconsistent spacing between \cventry items: the class starts each
% \cventry with \vspace{-2mm} to absorb space from a description block.
% Entries with empty 5th arg skip the block, ending up too tight.
% Appending \vspace{1.5mm} after every entry gives uniform spacing.
\let\origcventry\cventry
\renewcommand*{\cventry}[5]{%
  \origcventry{#1}{#2}{#3}{#4}{#5}\vspace{1.5mm}}
