...
% \apptocmd adds \cventryskip after every entry including the last.
% To avoid making the gap before the next \cvsection larger only when
% cventries precedes it, we use a boolean flag set by \end{cventries}.
\newlength{\cventryskip}
\setlength{\cventryskip}{6pt}
\apptocmd{\cventry}{\vspace{\cventryskip}}{}{}

\newbool{aftercventries}
\boolfalse{aftercventries}
\AfterEndEnvironment{cventries}{\booltrue{aftercventries}}
\pretocmd{\cvsection}{%
  \ifbool{aftercventries}{\vspace{-\cventryskip}}{}%
  \boolfalse{aftercventries}%
}{}{}
...
\ifbool{showTalksSection}{%
  ...
  \iftoggle{showTalks}{\vspace{10pt}\input{sections/talks}}{}
