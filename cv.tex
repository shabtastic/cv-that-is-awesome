...
% \AtEveryBibitem: increment our per-section index counter
...
% \finishbibsection{name} — call after each \printbibliography block.
%   Writes this section's item count to cvbibcounts.tex for the next compile.
%   We write to a dedicated side file to avoid all \@ machinery.
...
% Load counts written by previous pass (file won't exist on very first run)
