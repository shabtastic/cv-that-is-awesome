...
%==============================================================================
% showBibNumbers / reverseBibNumbers are declared and set via cv-preset.tex
...
%==============================================================================
% TOGGLE DECLARATIONS
% Values are set by the active preset file (cv-preset.tex).
% To build a specific variant:
%   make full       → cv-full.pdf
%   make industry   → cv-industry.pdf
%   make speaking   → cv-speaking.pdf
% Or manually: cp config/full.tex cv-preset.tex && make pdf
%==============================================================================
...
% Publication filters
\newtoggle{selectedOnlyPublications}
\newtoggle{selectedOnlyPatents}
...
%------------------------------------------------------------------------------
% ACTIVE PRESET
% cv-preset.tex is auto-generated by the Makefile (see config/).
% Default (fallback for fresh clones): config/full.tex
%------------------------------------------------------------------------------
\input{cv-preset}
...
\ifbool{showTalksSection}{%
  ...
  % sections/talks.tex must use \cvsubsection (not \cvsection) for the talks heading.
